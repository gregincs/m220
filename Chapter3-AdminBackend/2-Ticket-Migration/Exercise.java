...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mfix-qxzw8.mongodb.net/test?retryWrites=true&w=majority";
        ...
        Bson dateStringFilter = Filters.and( Filters.exists("lastupdated"), Filters.type("lastupdated", BsonType.STRING));
        ...
        Bson ratingStringFilter = Filters.and(Filters.exists("imdb.rating"), Filters.type("imdb.rating", BsonType.STRING));
